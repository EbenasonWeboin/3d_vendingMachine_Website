...
export default function WhyChooseUs() {
  ...
  return (
    <section ref={sectionRef} id="solutions" className="relative h-screen flex items-center bg-transparent overflow-hidden z-10 border-t border-white/5">
      ...
      <div ref={sliderRef} className="flex gap-8 px-12 md:px-24 mt-32 w-max">
        {benefits.map((benefit, i) => (
          <div 
            key={i} 
            className="w-[300px] h-[400px] glass-panel rounded-3xl p-8 flex flex-col justify-end shrink-0 relative overflow-hidden group"
          >
